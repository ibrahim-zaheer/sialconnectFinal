...
const token = localStorage.getItem("token");
  ...
  async function submitRequest(data) {
    ...
    try {
      ...
      const response = await axios.post("/api/adminVerification/request", formData, {
        headers: {
...
// Button component
export default function VerificationRequestButton({ className, disabled, onVerificationSubmitted }) {
