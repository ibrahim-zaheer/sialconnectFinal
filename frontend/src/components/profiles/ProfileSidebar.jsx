...
//     {
//       id: "profile",
//       label: t("profile:profile_sidebar.profile"),
//       icon: "user",
//     },
//     {
//       id: "offers",
//       label: t("profile:profile_sidebar.offers"),
//       icon: "briefcase",
//     },
//     {
//       id: "reviews",
//       label: t("profile:profile_sidebar.reviews"),
//       icon: "star",
//     },
//   ];
...
//           {
//             id: "payments",
//             label: t("profile:profile_sidebar.payments"),
//             icon: "credit-card",
//           },
//         ]
//       : [];
...
//                 {user.name || t("profile_sidebar.guest")}
//               </h3>
//               <p className="text-sm text-primary-600">
//                 {user.role || t("profile_sidebar.no_role")}
//               </p>
//             </div>
//           </div>
//         </div>
        ...
        <div className="flex flex-col flex-1 justify-between">
          ...
          <div className="p-4 border-t border-neutral-200">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 text-base font-medium rounded-lg transition-all"
            >
              <span className="mr-3">
