...
const EditProductForm = ({ product, onClose, onProductUpdated }) => {
  const [formData, setFormData] = useState({
    ...
    description: product.description,
    price: product.price,
    samplePrice: product.samplePrice || "",  // Add samplePrice to form data
    category: product.category || "Other", // default fallback
    images: product.image || [],
    discounts: product.discounts || [],
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("description", formData.description);
      formDataToSend.append("price", formData.price);
      formDataToSend.append("samplePrice", formData.samplePrice);  // Append samplePrice
      formDataToSend.append("category", formData.category);
