...
//         if (message) toast.error(message); // e.g. "CNIC already in use"
    
//         if (Array.isArray(errors)) {
//           errors.forEach((errMsg) => toast.error(errMsg)); // Joi errors
//         }
//       } else {
      ...
      if (error.response) {
        ...
        if (fieldErrors) {
          ...
          Object.keys(fieldErrors).forEach(field => {
            backendErrors[field] = fieldErrors[field].join(', ');
          });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  value={formData.businessName}
                  onChange={handleChange}
                  className={`w-full px-3 py-2 border ${errors.businessName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`}
                  placeholder="Enter business name"
                />
              ...
              <div className="space-y-1 md:col-span-2">
                ...
                <input
                  ...
                  value={formData.businessAddress}
                  onChange={handleChange}
                  className={`w-full px-3 py-2 border ${errors.businessAddress ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`}
                  placeholder="Enter business address"
                />
